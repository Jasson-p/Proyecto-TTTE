...
public class DatabaseWebSecurity {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/barbero/**").hasAnyAuthority("administrador")
                .requestMatchers("/cita/crear", "/cita/index").hasAnyAuthority("administrador", "barbero", "cliente")
                .requestMatchers("/cliente/**").hasAnyAuthority("administrador")
                .requestMatchers("/servicio/crear", "/servicio/index").hasAnyAuthority("administrador", "barbero")

                // La regla del administrador puede ser una combinación del hasAnyAuthority y el anyRequest()
                // Así nos aseguramos de que el administrador pueda acceder a todo.
                .requestMatchers("/administrador/**").hasAnyAuthority("administrador")
